{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-3efb98ac-6784-434b-99c2-a4479f0061c8" = [ ];
      "ActivityManager"."switch-to-activity-9ab43224-226d-4ebe-8d33-247370e0f478" = [ ];
      ...
      "plasmashell"."clipboard_action" = "Meta+Ctrl+X,none";
      ...
      "plasmashell"."repeat_action" = "Meta+Ctrl+R,none";
      "plasmashell"."show dashboard" = "Ctrl+F12";
      "plasmashell"."show-barcode" = [ ];
      "plasmashell"."show-on-mouse-pos" = "Meta+V,none";
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,10,23,21,1,7.813";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."3efb98ac-6784-434b-99c2-a4479f0061c8" = "Default";
      "kactivitymanagerdrc"."activities"."9ab43224-226d-4ebe-8d33-247370e0f478" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "9ab43224-226d-4ebe-8d33-247370e0f478";
      ...
      "kwinrc"."Desktops"."Id_1" = "462eee36-0f2d-4d06-bf0b-d58d3e0ea64c";
      ...
      "kwinrc"."Tiling/6aae7b0b-c718-5194-b53c-4693548dda59"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/88e5e630-4dd9-5320-a0e7-37b9be65c4ad"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/a88df698-6c8f-5d27-9d1c-046d5a9dc4bd"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/ca9f6cd5-6b3d-5975-ad99-9254e494f541"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
